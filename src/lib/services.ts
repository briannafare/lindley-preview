...
export const services: ServiceData[] = [
  {
    ...
    description: "A purchase loan is the mortgage you use to buy a home. Unlike working directly with a bank that can only offer their own products, working with The Lindley Team gives you access to hundreds of lending products across multiple institutions. We shop the market so you don't have to — finding the right loan structure for your income, credit profile, down payment, and long-term financial goals. Whether you're a first-time buyer in Portland's Sellwood neighborhood or upgrading to a larger home in Lake Oswego, the purchase process starts with understanding where you are financially and where you want to go.",
    icon: "circle",
    tag: "Most Popular",
    seo: {
      title: "Portland Purchase Mortgage Loans | The Lindley Team",
      description: "Get pre-approved for a Portland home purchase. Access hundreds of mortgage products across Oregon and Washington. 30 years experience. NMLS #1367416.",
    ...
    pros: [
      ...
      "Access to hundreds of product options through our brokerage",
    ...
    faqs: [
      ...
      { q: "What's the difference between a mortgage broker and a bank?", a: "Banks can only offer their own lending products at retail rates. As a mortgage broker, The Lindley Team has access to hundreds of products from multiple lenders. We shop the wholesale market to find you better rates and terms than you'd get walking into a single bank." },
  ...
  },
  {
    ...
    process: [
      ...
      { step: "02", title: "Rate Lock & Application", desc: "Once we confirm it makes sense, we lock your rate and start the application. We pull from multiple lenders to find the best terms." },
